    ...
    <section className="flex flex-col items-center bg-accessCardBgColor mx-5 pb-9  rounded translate-y-40 md:max-w-4xl md:mx-auto">
      ...
      >
        <input
          ...
          className=" rounded-full h-12 w-[17.5rem] pl-8 mb-6 text-accessCardInputColor placeholder:text-accessCardInputColor font-secondary text-sm lg:mb-0 lg:w-[30rem]"
        />
        <CtaButton2 />
      </form>
    </section>
